                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                        ...
                                        <div className="text-center">
                                            <div className="text-2xl font-bold text-blue-600">{stats.queueStats.downloading}</div>
                                            <p className="text-xs text-muted-foreground">Téléchargement</p>
                                        </div>
                                        <div className="text-center">
                                            <div className="text-2xl font-bold text-red-600">{stats.queueStats.failed}</div>
