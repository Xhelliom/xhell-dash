    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="bottom" className="h-[90vh] max-h-[90vh] overflow-y-auto p-6">
        <SheetHeader className="pb-4 border-b px-0">
          ...
          <SheetDescription>Vue d'ensemble de votre cluster Proxmox</SheetDescription>
        </SheetHeader>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <Card>
                    ...
                    <CardContent>
                      ...
                      <p className="text-xs text-muted-foreground">Dans le cluster</p>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      ...
                      <p className="text-xs text-muted-foreground">{stats.activeVMs} actives</p>
                    </CardContent>
                  </Card>
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      {stats.nodes.map((node) => {
                        ...
                        return (
                          <div key={node.node} className="p-3 rounded-lg border bg-card">
                            <div className="flex items-center justify-between mb-2">
