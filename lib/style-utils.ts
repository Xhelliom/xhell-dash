...
export function applyStylePreset(preset: StylePreset): void {
  ...
  root.style.setProperty(
    "--shadow-2xs",
    `${shadowBase} hsl(0 0% 0% / ${parseFloat(shadow.opacity) * 0.25})`
  );
  root.style.setProperty(
    "--shadow-xs",
    `${shadowBase} hsl(0 0% 0% / ${parseFloat(shadow.opacity) * 0.25})`
  ...
  root.style.setProperty(
    "--shadow-sm",
    `${shadowBase} hsl(0 0% 0% / ${shadow.opacity}), ${shadow.offsetY}px 1px 2px -5px hsl(0 0% 0% / ${shadow.opacity})`
  );
  root.style.setProperty(
    "--shadow",
    `${shadowBase} hsl(0 0% 0% / ${shadow.opacity}), ${shadow.offsetY}px 1px 2px -5px hsl(0 0% 0% / ${shadow.opacity})`
  ...
  root.style.setProperty(
    "--shadow-md",
    `${shadowBase} hsl(0 0% 0% / ${shadow.opacity}), ${shadow.offsetY}px 2px 4px -5px hsl(0 0% 0% / ${shadow.opacity})`
  );
  root.style.setProperty(
    "--shadow-lg",
    `${shadowBase} hsl(0 0% 0% / ${shadow.opacity}), ${shadow.offsetY}px 4px 6px -5px hsl(0 0% 0% / ${shadow.opacity})`
  );
  root.style.setProperty(
    "--shadow-xl",
    `${shadowBase} hsl(0 0% 0% / ${shadow.opacity}), ${shadow.offsetY}px 8px 10px -5px hsl(0 0% 0% / ${shadow.opacity})`
  );
  root.style.setProperty(
    "--shadow-2xl",
    `${shadowBase} hsl(0 0% 0% / ${parseFloat(shadow.opacity) * 2.5})`
  );

  // Appliquer les fonts
  root.style.setProperty(
    "--font-sans",
    fontValues[preset.font] === fontValues.sans ? fontValues[preset.font] : fontValues.sans
  );
  root.style.setProperty(
    "--font-serif",
    fontValues[preset.font] === fontValues.serif ? fontValues[preset.font] : fontValues.serif
  );
  root.style.setProperty(
    "--font-mono",
    fontValues[preset.font] === fontValues.mono ? fontValues[preset.font] : fontValues.mono
  );
