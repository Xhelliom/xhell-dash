...
process.env.ENCRYPTION_KEY =
  process.env.ENCRYPTION_KEY || "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef"; // 64 caractères hex pour les tests
...
// Le mock de fs est géré localement dans db.test.ts
