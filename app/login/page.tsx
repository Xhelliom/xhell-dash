  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle className="text-center">Connexion au Xhell Dashboard</CardTitle>
        </CardHeader>
        <CardContent>
          ...
          {showDefaultCredentials && (
            <>
              <p className="mt-4 text-xs text-muted-foreground text-center">
                Un administrateur par défaut est créé automatiquement s&apos;il n&apos;existe pas :
                email <code className="font-mono">xhell-admin@example.com</code> / mot de passe{" "}
