...
export async function GET(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    return NextResponse.json({ error: "Impossible de récupérer le widget" }, { status: 500 });
  }
}
...
export async function PUT(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    return NextResponse.json({ error: "Impossible de mettre à jour le widget" }, { status: 500 });
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json({ error: "Impossible de supprimer le widget" }, { status: 500 });
  }
}
