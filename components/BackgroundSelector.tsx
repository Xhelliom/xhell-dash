 ...
 */
export function BackgroundSelector({ value, onValueChange, className }: BackgroundSelectorProps) {
  return (
      ...
      <Select value={value} onValueChange={onValueChange}>
        ...
        <SelectContent>
          {backgroundEffects.map((effect) => (
            <SelectItem key={effect.value} value={effect.value} title={effect.description}>
