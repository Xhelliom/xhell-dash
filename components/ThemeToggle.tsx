...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      ...
      <ToggleGroupItem value="light" aria-label="Thème clair" title="Thème clair">
        <Sun className="h-4 w-4" />
      </ToggleGroupItem>

      {/* Bouton pour le thème système */}
      <ToggleGroupItem value="system" aria-label="Thème système" title="Thème système">
        <Monitor className="h-4 w-4" />
      </ToggleGroupItem>

      {/* Bouton pour le thème sombre */}
      <ToggleGroupItem value="dark" aria-label="Thème sombre" title="Thème sombre">
